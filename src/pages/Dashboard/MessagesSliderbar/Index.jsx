        ...
        <div class="h-full w-96 border-r border-base-200 flex flex-col">
            ...
            <div class="h-screen overflow-auto">
                {contacts.map((contact) => (
                    <NavLink to={`/dashboard/messages/${contact._id}`} activeClassName="active" className="flex items-center space-x-2 mt-5">
                        <Contact contactName={contact._id} contactLastText="Ok, Thanks." />
                    </NavLink>
